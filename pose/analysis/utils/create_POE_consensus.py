...
if __name__ == '__main__':
    ...
    parser.add_argument('--rate', type=int, default=25,
                        help='resample data to this frame rate')
    parser.add_argument('--info_file', type=str2bool, nargs='?', default=True,
                        help='generate an info file with meta data about '
                        'dataset, such as keypoints used, indices for different'
                        ' videos and repetitions, etc')
